<?php
class ET_Builder_Module_Post_Slider2 extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Post Slider 2', 'et_builder' );
		$this->slug       = 'et_pb_post_slider2';
		...
		$this->main_css_element = '%%order_class%%.et_pb_slider_1';
		...
		$this->custom_css_options = array(
			...
			'slide_arrows' => array(
				...
				'selector' => '.et-pb-slider-arrows_custom a',
			),
		);
	}
	...
	function get_fields() {
		$fields = array(
			...
			'__posts' => array(
				'type'                => 'computed',
				'computed_callback'   => array( 'ET_Builder_Module_Post_Slider2', 'get_blog_posts' ),
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$output = sprintf(
			'<div%3$s class="et_pb_module  et_pb_slider_1 et_pb_post_slider%1$s%4$s">
...
new ET_Builder_Module_Post_Slider2;